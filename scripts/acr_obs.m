...
title('Z-score of distances using source sessions to predict target sessions')

imagesc(percent_mat);
colorbar;
ylabel('Source Sessions');
xlabel('Target Sessions');
title('Percentile of distances using source sessions to predict target sessions')
