...
% Generates a struct with rgb values for plotting hyperalignment figures.
    ...
    % colors.R050.f = [104/255 34/255 139/255];  % dark purple
    % colors.R050.w = [216/255 191/255 216/255];  % lighter purple
    % colors.R064.f = [198/255 113/255 113/255];  % dark salmon
    % colors.R064.w = [238/255 213/255 210/255];  % lighter salmon/dusty pink
